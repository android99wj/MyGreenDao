...
public class UserDao extends AbstractDao<User, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property UserSonId = new Property(3, Long.class, "userSonId", false, "USER_SON_ID");
    };
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER\" (" + //
                ...
                "\"NAME\" TEXT," + // 1: name
                "\"AGE\" TEXT," + // 2: age
                "\"USER_SON_ID\" INTEGER);"); // 3: userSonId
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3) // userSonId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setUserSonId(cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getUserSonDao().getAllColumns());
            builder.append(" FROM USER T");
            builder.append(" LEFT JOIN USER_SON T0 ON T.\"USER_SON_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected User loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        UserSon userSon = loadCurrentOther(daoSession.getUserSonDao(), cursor, offset);
        entity.setUserSon(userSon);
